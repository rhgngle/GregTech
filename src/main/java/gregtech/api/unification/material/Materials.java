...
public class Materials {
    ...
    public static Material deacidifiedOil;
    public static Material deacidifiedHeavyOil;
    public static Material deacidifiedRawOil;
    public static Material deacidifiedLightOil;
    public static Material deacidifiedDesaltedOil;
    public static Material deacidifiedDesaltedHeavyOil;
    public static Material deacidifiedDesaltedRawOil;
    public static Material deacidifiedDesaltedLightOil;
    public static Material naphthenateRichPetroleumWastewater;
    public static Material naphthenicAcid;
    public static Material petroleumWastewater;
    public static Material magnesiumDepletedpetroleumWastewater;
    public static Material magnesiumCalciumDepletedpetroleumWastewater;
    public static Material atmosphericResidue;
    public static Material olefinRichRefineryGas;
    public static Material ultraLowSulfurHeavyFuel;
    public static Material ultraLowSulfurLightFuel;
    public static Material ultraLowSulfurNaphtha;
    public static Material nonane;
    public static Material undecane;
    public static Material tridecane;
    public static Material tetradecane;
    public static Material pentadecane;
    public static Material hexadecane;
    public static Material naphthaReformate;
    public static Material ultraLowSulfurNaphthaReformate;
    public static Material btxMixture;
    public static Material aromaticsDepletedNaphthaReformate;
    public static Material aromaticsDepletedUltraLowSulfurNaphthaReformate;
    public static Material xylene;
    public static Material octaneBoostedLightFuel;
    public static Material octaneBoostedNaphtha;
    public static Material ultraLowSulfurOctaneBoostedLightFuel;
    public static Material ultraLowSulfurOctaneBoostedNaphtha;
    public static Material ultraLowSulfurDiesel;
    public static Material ultraLowSulfurCetaneBoostedDiesel;
    public static Material ultraLowSulfurGasoline;
    public static Material ultraLowSulfurHighOctaneGasoline;
    public static Material dimethylEther;
    public static Material nitroform;
    public static Material nitratedAlkanes;
    public static Material nitromethane;
    public static Material nitroethane;
    public static Material nitropropane1;
    public static Material nitropropane2;
    public static Material isobutane;
    public static Material isobutylene;
    public static Material vacuumDistillationResidue;
    public static Material sulfuricDeasphaltedOil;
    public static Material deasphaltedOil;
    public static Material asphalt;
    public static Material petroleumCoke;
    public static Material rawLubricant;
    ...
    public static Material adamantaneOil;
    ...
    public static Material heptane;
    ...
    public static Material rutheniumNitrosylNitrate;
    public static Material bariumNitrate;
    public static Material uncalcinedRutheniumOnAlumina;
    public static Material rutheniumOnAlumina;
    public static Material bariumRutheniumOnAlumina;
    public static Material fluidCatalyticCrackingCatalyst;
    public static Material nitrogenFixationCatalyst;
